 <footer class="footer">
   <div class="footerContainer">
    	<h2 class="heading"> Sloane Gallery of Art | 1777 Larimer St #1010  Denver, CO 80202 | (303)595 4230 | <?php echo '<a itemscope itemtype="http://schema.org/Person" href="http://aleksandrantonov.com"><span itemprop="name">Aleksandr Antonov</span></a> &copy;'.date("Y"); ?> </h2>
